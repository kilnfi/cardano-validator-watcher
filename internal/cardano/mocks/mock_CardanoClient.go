...
// PingVersion provides a mock function with given fields: ctx
func (_m *MockCardanoClient) PingVersion(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for PingVersion")
	}
...
// MockCardanoClient_PingVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PingVersion'
type MockCardanoClient_PingVersion_Call struct {
	*mock.Call
}

// PingVersion is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockCardanoClient_Expecter) PingVersion(ctx interface{}) *MockCardanoClient_PingVersion_Call {
	return &MockCardanoClient_PingVersion_Call{Call: _e.mock.On("PingVersion", ctx)}
}

func (_c *MockCardanoClient_PingVersion_Call) Run(run func(ctx context.Context)) *MockCardanoClient_PingVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockCardanoClient_PingVersion_Call) Return(_a0 error) *MockCardanoClient_PingVersion_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCardanoClient_PingVersion_Call) RunAndReturn(run func(context.Context) error) *MockCardanoClient_PingVersion_Call {
	_c.Call.Return(run)
	return _c
}
